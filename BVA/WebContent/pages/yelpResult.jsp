...
<script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/jquery/1.8.2/jquery.min.js"></script>
		...
		var arr = <%=session.getAttribute("YelpResult") %>;
		console.log(arr);
		//Printing Pie1 Sentiment Scores for Chart
		var pie1positive = parseFloat(arr.pie1[0].positive);
		var pie1negative = parseFloat(arr.pie1[0].negative);
		var pie1neutral = parseFloat(arr.pie1[0].neutral);

		//Printing Pie2 Sentiment Scores for Chart
		var pie2positive = parseFloat(arr.pie2[0].positive);
		var pie2negative = parseFloat(arr.pie2[0].negative);
		var pie2neutral = parseFloat(arr.pie2[0].neutral);

		//Printing Pie3 Sentiment Scores for Chart
		var pie3positive = parseFloat(arr.pie3[0].positive);
		var pie3negative = parseFloat(arr.pie3[0].negative);
		var pie3neutral = parseFloat(arr.pie3[0].neutral);
...
$(setTimeout(function () {
    $('#container').highcharts({
        ...
        title: {
            text: 'Restaurant-1 Overall Sentiment  '
        },
        tooltip: {
...
$(setTimeout(function () {
    $('#container2').highcharts({
        ...
        title: {
            text: 'Restaurant-2 Overall Sentiment '
        },
        tooltip: {
    	    pointFormat: '{series.name}: <b>{point.percentage:.1f}%</b>'
        },
        ...
        series: [{
            ...
            name: 'Sentiment',
            data: [
                ['Positive',   pie2positive],
                ['Negative',   pie2negative],
                ['Neutral',   pie2neutral],
            ]
        }]
    });
...
$(setTimeout(function () {
    $('#container3').highcharts({
        ...
        series: [{
            ...
            name: 'Sentiment',
            data: [
                ['Positive',   pie3positive],
                ['Negative',   pie3negative],
                ['Neutral',   pie3neutral],
            ]
        }]
    });
...
$(setTimeout(function () {
    $('#container4').highcharts({
        ...
        series: [{
            ...
            data: [[1, 0.906], [4, 0.116], [6, 0.446], [8, 0.580], [10, 0.056]]

        }, {
            name: 'Negative',
            color: 'rgba(119, 152, 191, .5)',
            data: [[2, -0.226], [3, -0.075], [5, -0.396], [7, -0.736], [9, -0.903]]
        }]
    });
},3000));
</script>
	...
	<article class="content light">
		<div class="full">
			<section class="half car-show-1">
				...
				<div class="title-two">Your Competitors BRAND Value..</div>
				<!--  <div class="half-content">
					<div id="container" style="min-width: 310px; height: 400px; margin: 0 auto"></div>
                            ...
                            <div class="caroussel-list">
                                <div class="car-img">
                                <div id="container" style="min-width: 400px; height: 395px; margin: 0 auto"></div>
                                </div>
			...
			<section id=anchor4 class="half car-show-2 hideme dontHide">
				<div class="title-one">Yelp</div>
				<div class="title-two">What people THINK about your competitor?</div>
				<div class="show">
						...
						<div class="caroussel-list-2">
							<div class="car-quote">
								<div class="testimonials">
									<div class="avatar">
										<img src="../img/testimonials/yelpicon.jpg" alt='img'>
									</div>
									<div class="comment">
										"<script type="text/javascript">document.write(arr.Restaurant1[0].review);</script>"<br>
										<br> Sentiment: <span><script type="text/javascript">document.write(arr.Restaurant1[0].sentiment);</script></span>
									</div>
									...
									<div class="comment">
										"<script type="text/javascript">document.write(arr.Restaurant1[1].review);</script>"<br><br> <br> Sentiment: <span><script type="text/javascript">document.write(arr.Restaurant1[1].sentiment);</script></span> | <span>'<script type="text/javascript">document.write(arr.restaurant1);</script>'</span>
									</div>
								</div>
							</div>
                                <div class="car-quote">
                                	<div class="testimonials">
                                    	<div class="avatar"><img src="../img/testimonials/yelpicon.jpg" alt='img'></div>
                                        <div class="comment">"<script type="text/javascript">document.write(arr.Restaurant2[0].review);</script>"<br><br>Sentiment: <span><script type="text/javascript">document.write(arr.Restaurant2[0].sentiment);</script></span> | <span>'<script type="text/javascript">document.write(arr.restaurant1);</script>'</span> </div>

                                        <div class="clear q-spacer"></div>
                                        <div class="avatar"><img src="../img/testimonials/yelpicon.jpg" alt='img'></div>
                                        <div class="comment"><div class="comment">"<script type="text/javascript">document.write(arr.Restaurant2[1].review);</script>"<br><br>Sentiment: <span><script type="text/javascript">document.write(arr.Restaurant2[1].sentiment);</script></span> |<span>'<script type="text/javascript">document.write(arr.restaurant2);</script>'</span> | <span>'<script type="text/javascript">document.write(arr.restaurant2);</script>'</span></div>
                                    </div>
                                </div>
                                </div>
                                <div class="car-quote">
                                	<div class="testimonials">
                                    	<div class="avatar"><img src="../img/testimonials/yelpicon.jpg" alt='img'></div>
                                        <div class="comment">"<script type="text/javascript">document.write(arr.Restaurant3[0].review);</script>"<br><br>Sentiment: <span><script type="text/javascript">document.write(arr.Restaurant3[0].sentiment);</script></span>| <span>'<script type="text/javascript">document.write(arr.restaurant3);</script>'</span></div>

                                        <div class="clear q-spacer"></div>
                                        <div class="avatar"><img src="../img/testimonials/yelpicon.jpg" alt='img'></div>
                                        <div class="comment">"<script type="text/javascript">document.write(arr.Restaurant3[1].review);</script>"<br><br>Sentiment: <span><script type="text/javascript">document.write(arr.Restaurant3[1].sentiment);</script></span>| <span>'<script type="text/javascript">document.write(arr.restaurant3);</script>'</span></div>
                                    </div>
                                </div>
					</div>
				</div>
