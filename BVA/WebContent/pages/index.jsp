					...
					<div class="sk-container">
						<div class="skill-content">
							<div class="progress-bar skill-1">
								<div class="skill-in" title="90">
									<div class="info-skills">
										Server-side development <span>- 90%</span>
									</div>
								</div>
							</div>
						</div>
						<div class="skill-content">
							<div class="progress-bar skill-2">
								<div class="skill-in" title="70">
									<div class="info-skills">
										API code and Algorithms<span>- 70%</span>
									</div>
								</div>
							</div>
						</div>
						<div class="skill-content">
							<div class="progress-bar skill-3">
								<div class="skill-in" title="80">
									<div class="info-skills">
										Client-side development <span>- 80%</span>
									</div>
								</div>
							</div>
						</div>
						<div class="skill-content">
							<div class="progress-bar skill-4">
								<div class="skill-in" title="60">
									<div class="info-skills">
										User Interface <span>- 60%</span>
									</div>
								</div>
							</div>
						</div>
						<div class="skill-content">
							<div class="progress-bar skill-5">
								<div class="skill-in" title="100">
									<div class="info-skills">
										MOtivation <span>- 100%</span>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="caroussel-list-2">
							<div class="car-quote">
								<div class="testimonials">
									<div class="avatar">
										<img src="../img/testimonials/avatar-01.jpg" alt='img'>
									</div>
									<div class="comment">
										"Elevate helped me analyze my brand's social media presense!"<br>
										<br> <span>Akash Mehta </span>Owner, Tandoori Tadka
									</div>
									<div class="clear q-spacer"></div>
									<div class="avatar">
										<img src="../img/testimonials/avatar-02.jpg" alt='img'>
									</div>
									<div class="comment">
										"Elevate helped me to rethink about my companies new mobile
										handset offering, as my competitors were being praised by
										customers for some features"<br> <br> <span>Dave
											Gershon, </span>Next Mobiles
									</div>
								</div>
							</div>
