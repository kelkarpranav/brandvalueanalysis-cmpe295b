...
var arr = <%=session.getAttribute("AmazonResult") %>;
console.log(arr);
...
$(setTimeout(function () {
    $('#container').highcharts({
        ...
        title: {
            text: 'Product-1 Overall Sentiment  '
        },
        tooltip: {
...
$(setTimeout(function () {
    $('#container2').highcharts({
        ...
        title: {
            text: 'Product-2 Overall Sentiment '
        },
        tooltip: {
    	    pointFormat: '{series.name}: <b>{point.percentage:.1f}%</b>'
        },
...
$(setTimeout(function () {
    $('#container4').highcharts({
        ...
        series: [{
            ...
            data: [[1, 0.1656], [4, 0.056], [6, 0.526], [8, 0.856], [10, 0.026]]

        }, {
            name: 'Negative',
            color: 'rgba(119, 152, 191, .5)',
            data: [[2, -0.256], [3, -0.756], [5, -0.056], [7, -0.956], [9, -0.466]]
        }]
    });
},3000));
</script>
	...
	<article class="content light">
		<div class="full">
				...
				<!--  <div class="half-content">
					<div id="container" style="min-width: 310px; height: 400px; margin: 0 auto"></div>
                            ...
                            <div class="caroussel-list">
                                ...
                                <div class="car-img">
                                <div id="container2" style="min-width: 420px; height: 400px; margin: 0 auto"></div>
                                </div>
			...
			<section id=anchor4 class="half car-show-2 hideme dontHide">
				<div class="title-one">Amazon</div>
						...
						<div class="caroussel-list-2">
							<div class="car-quote">
								<div class="testimonials">
									<div class="avatar">
										<img src="../img/testimonials/amazonicon.jpg" alt='img'>
									</div>
									<div class="comment">
										"<script type="text/javascript">document.write(arr.product1[0].review);</script>"<br>
										<br> Sentiment: <span><script type="text/javascript">document.write(arr.product1[0].sentiment);</script></span>
									</div>
									...
									<div class="comment">
										"<script type="text/javascript">document.write(arr.product1[1].review);</script>"<br><br> <br> Sentiment: <span><script type="text/javascript">document.write(arr.product1[1].sentiment);</script></span>
									</div>
								</div>
							</div>
                                <div class="car-quote">
                                	<div class="testimonials">
                                    	<div class="avatar"><img src="../img/testimonials/amazonicon.jpg" alt='img'></div>
                                        <div class="comment">"<script type="text/javascript">document.write(arr.product2[0].review);</script>"<br><br>Sentiment: <span><script type="text/javascript">document.write(arr.product2[0].sentiment);</script></span></div>

                                        <div class="clear q-spacer"></div>
                                        <div class="avatar"><img src="../img/testimonials/amazonicon.jpg" alt='img'></div>
                                        <div class="comment"><div class="comment">"<script type="text/javascript">document.write(arr.product2[1].review);</script>"<br><br>Sentiment: <span><script type="text/javascript">document.write(arr.product2[1].sentiment);</script></span></div>
                                    </div>
                                </div>
                                </div>
                                <div class="car-quote">
                                	<div class="testimonials">
                                    	<div class="avatar"><img src="../img/testimonials/amazonicon.jpg" alt='img'></div>
                                        <div class="comment">"<script type="text/javascript">document.write(arr.product3[0].review);</script>"<br><br>Sentiment: <span><script type="text/javascript">document.write(arr.product3[0].sentiment);</script></span></div>

                                        <div class="clear q-spacer"></div>
                                        <div class="avatar"><img src="../img/testimonials/amazonicon.jpg" alt='img'></div>
                                        <div class="comment">"<script type="text/javascript">document.write(arr.product3[1].review);</script>"<br><br>Sentiment: <span><script type="text/javascript">document.write(arr.product3[1].sentiment);</script></span></div>
                                    </div>
                                </div>
					</div>
				</div>
